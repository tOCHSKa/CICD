<template>
    <NavigationBar />
    <div class="container">
        <img src="../assets/img/scifiPage.png" alt="" class="backgroundimg">
        <img src="../assets/img/SCI-FI.svg" alt="" class="svgimg">
    </div>
...
const fetchThrillerGenres = async () => {
    try {
        const response = await fetch('http://localhost:3001/api/search/genre/Sci-Fi');
